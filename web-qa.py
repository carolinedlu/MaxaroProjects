...
full_url = "https://en.wikipedia.org/"
...
# Check and create 'maxaro.nl' sub-directory if it doesn't exist
if not os.path.exists('text/maxaro.nl/'):
    os.makedirs('text/maxaro.nl/')
